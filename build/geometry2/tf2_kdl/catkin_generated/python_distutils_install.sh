...
echo_and_run cd "/home/stefan/rostest_ws/src/geometry2/tf2_kdl"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/stefan/rostest_ws/src/geometry2/tf2_kdl/setup.py" \
     \
    build --build-base "/home/stefan/rostest_ws/build/geometry2/tf2_kdl" \
    install \
    --root="${DESTDIR-/}" \
