...
echo_and_run cd "/home/stefan/rostest_ws/src/geometry2/tf2_geometry_msgs"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/stefan/rostest_ws/src/geometry2/tf2_geometry_msgs/setup.py" \
     \
    build --build-base "/home/stefan/rostest_ws/build/geometry2/tf2_geometry_msgs" \
    install \
    --root="${DESTDIR-/}" \
