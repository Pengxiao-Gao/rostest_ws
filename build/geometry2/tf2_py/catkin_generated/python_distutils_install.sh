...
echo_and_run cd "/home/stefan/rostest_ws/src/geometry2/tf2_py"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/stefan/rostest_ws/src/geometry2/tf2_py/setup.py" \
     \
    build --build-base "/home/stefan/rostest_ws/build/geometry2/tf2_py" \
    install \
    --root="${DESTDIR-/}" \
